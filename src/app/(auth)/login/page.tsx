...
export default function LoginPage() {
  ...
  return (
    <div>
      ...
      <div className="flex bg-card p-1 rounded-lg border border-border mb-6 animate-slide-in-up opacity-0" style={{ animationDelay: '30ms', animationFillMode: 'forwards' }}>
        <button
          ...
          className={`flex-1 py-1.5 text-[13px] font-medium rounded-md transition-all duration-200 ${
            loginType === 'student' ? 'bg-muted text-white shadow-sm' : 'text-zinc-500 hover:text-zinc-300'
          }`}
        >
          Student
        </button>
        <button
          ...
          className={`flex-1 py-1.5 text-[13px] font-medium rounded-md transition-all duration-200 ${
            loginType === 'faculty' ? 'bg-muted text-white shadow-sm' : 'text-zinc-500 hover:text-zinc-300'
          }`}
        >
          Faculty / Admin
        </button>
      ...
      {loginType === 'student' && (
        ...
        >
          <button
            ...
            className="flex items-center justify-center gap-2 h-10 rounded-lg text-[13px] font-medium text-zinc-300 transition-all duration-200 hover:text-white hover:bg-[#1a1a1d] disabled:opacity-40 bg-card border border-border hover:border-[#2a2a2e]"
          >
            {oauthLoading === 'google' ? (
      ...
      {!isNativeApp && (
        <div
          className="mt-8 pt-6 border-t border-border animate-slide-in-up opacity-0 text-center"
        ...
        >
          ...
          <a
            ...
            className="inline-flex items-center justify-center gap-2 h-9 px-4 rounded-lg text-[12px] font-medium text-zinc-300 transition-all duration-200 hover:text-white hover:bg-[#1a1a1d] bg-card border border-border hover:border-indigo-500/30"
          >
