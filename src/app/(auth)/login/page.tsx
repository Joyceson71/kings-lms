    ...
    <div>
      ...
      <div className="mb-8">
        ...
        <p className="text-[13px] text-zinc-500 mt-1">
          to continue to Kings EC Platform
        </p>
      </div>
      ...
      {error && (
        <div
          className="flex items-start gap-2.5 px-3 py-2.5 rounded-md text-[13px] text-red-400 mb-5 animate-slide-in-up"
      ...
      <div className="grid grid-cols-2 gap-2 mb-5">
        <button
          ...
          disabled={isPending}
          className="flex items-center justify-center gap-2 h-9 rounded-md text-[13px] font-medium text-zinc-300 transition-colors hover:text-white disabled:opacity-40"
      ...
      <form onSubmit={handleSubmit} className="space-y-3">
        ...
        <div>
          ...
          <input
            ...
            autoComplete="email"
            disabled={isPending}
            className="w-full h-9 px-3 rounded-md text-[13px] text-white placeholder:text-zinc-600 outline-none transition-all disabled:opacity-50"
            style={{ background: '#111113', border: '1px solid #1f1f23' }}
            onFocus={e => {
              e.currentTarget.style.borderColor = '#6366f1';
              e.currentTarget.style.boxShadow = '0 0 0 2px rgb(99 102 241 / 0.12)';
            }}
            onBlur={e => {
        ...
        <div>
          ...
          <div className="relative">
            <input
              ...
              disabled={isPending}
              className="w-full h-9 pl-3 pr-9 rounded-md text-[13px] text-white placeholder:text-zinc-600 outline-none transition-all disabled:opacity-50"
              style={{ background: '#111113', border: '1px solid #1f1f23' }}
              onFocus={e => {
                e.currentTarget.style.borderColor = '#6366f1';
                e.currentTarget.style.boxShadow = '0 0 0 2px rgb(99 102 241 / 0.12)';
        ...
        <button
          ...
          type="submit"
          disabled={isPending}
          className="w-full h-9 rounded-md text-[13px] font-medium text-white transition-all disabled:opacity-50 flex items-center justify-center gap-2 group mt-1"
          style={{ background: '#6366f1', border: '1px solid #818cf8' }}
          onMouseEnter={e => !isPending && (e.currentTarget.style.background = '#4f46e5')}
          onMouseLeave={e => !isPending && (e.currentTarget.style.background = '#6366f1')}
        >
          {isPending ? (
