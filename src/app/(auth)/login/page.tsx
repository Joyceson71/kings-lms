...
export default function LoginPage() {
  ...
  return (
    <div>
        ...
        >
          ...
          >
            {oauthLoading === 'github' ? (
              ...
              <svg viewBox="0 0 24 24" className="h-4 w-4 flex-shrink-0 fill-foreground">
      ...
      {loginType === 'student' && (
        <p
          className="mt-6 text-center text-[13px] text-muted-foreground animate-slide-in-up opacity-0"
      ...
      {!isNativeApp && (
        ...
        >
          <p className="text-[12px] text-muted-foreground mb-3">Experience Kings LMS natively on your Android device.</p>
          <a
            href="/KingsLMS.apk"
            download="KingsLMS.apk"
            className="inline-flex items-center justify-center gap-2 h-9 px-4 rounded-lg text-[12px] font-medium text-muted-foreground transition-all duration-200 hover:text-foreground hover:bg-muted bg-card border border-border hover:border-indigo-500/30"
          >
