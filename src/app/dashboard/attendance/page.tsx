...
const QRScannerModal = dynamic(() => import('@/components/attendance/qr-scanner').then(mod => mod.QRScannerModal), { ssr: false });
    ...
    <div className="space-y-8">
      ...
      {isStudent && (
        <div className="grid grid-cols-2 sm:grid-cols-3 gap-3 sm:gap-4 animate-slide-in-up opacity-0" style={{ animationDelay: '80ms', animationFillMode: 'forwards' }}>
          {/* Attended */}
          <div
            className="bg-card border border-border rounded-2xl p-4 text-center overflow-hidden relative"
          ...
          {(() => {
            ...
            return (
              <div
                className="col-span-2 sm:col-span-1 border border-border rounded-2xl p-4 text-center overflow-hidden relative transition-all duration-300"
                style={{
                  background: '#111113',
