        ...
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-5">
          {filteredResources.map((resource, i) => {
            ...
            return (
              ...
              >
                <div className="bg-card border border-border rounded-2xl p-5 h-full flex flex-col group border border-border/40 hover:border-primary/30 transition-colors">
