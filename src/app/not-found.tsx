        ...
        <TiltCard intensity={15}>
          <div className="glass-card rounded-3xl p-8 md:p-12 text-center relative overflow-hidden">
            ...
            <div className="relative mb-8 flex justify-center">
              ...
              <h1 className="text-8xl md:text-9xl font-black tracking-tighter text-transparent bg-clip-text bg-gradient-to-br from-foreground via-primary to-background drop-shadow-sm" style={{ fontFamily: 'Outfit, sans-serif' }}>
                404
              </h1>
            </div>
